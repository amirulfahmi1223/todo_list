...
if (isset($_POST['submit'])) {
  if (tambahIssue($_POST) > 0) {
    echo '<script>alert("Tambah Issue Berhasil")</script>';
    echo '<script>window.location = "issue.php?status="</script>';
  } else {
    echo "<script>alert('Tambah Issue Gagal')</script>";
    echo mysqli_error($conn);
  }
}
$select = query("SELECT * FROM tb_user");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">Tambah Issue</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <?php foreach ($select as $rows) : ?>
                              <option value="<?= $rows['id_user']; ?>"><?= $rows['nm_user']; ?></option>
                            <?php endforeach; ?>
                            </select>
                          </div>
                        </div>
