...
if (isset($_POST['submit'])) {
  if (tambahTodo($_POST) > 0) {
    echo '<script>alert("Tambah Todo List Berhasil")</script>';
    echo '<script>window.location = "data-todo.php?status=Status"</script>';
  } else {
    echo "<script>alert('Tambah Todo List Gagal')</script>";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">To Do List</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="50" class="form-control mt-2" id="validationCustom01" name="kegiatan" placeholder="Masukkan Nama Kegiatan" required>
                      <br>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
