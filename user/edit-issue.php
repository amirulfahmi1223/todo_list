...
if (isset($_POST['submit'])) {
  if (ubahIssue($_POST) > 0) {
    echo '<script>alert("Ubah Issue Berhasil")</script>';
    // echo '<script>window.location = "data-todo.php"</script>';
  } else {
    echo "<script>alert('Tidak Ada Issue Yang Diubah')</script>";
    echo mysqli_error($conn);
  }
}
$pilih = query("SELECT*FROM tb_user");
$select = query("SELECT * FROM tb_issue INNER JOIN tb_user ON tb_issue.id_user = tb_user.id_user WHERE id_issue = '" . $id . "'")[0];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">Edit Issue</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="card-body">
                  <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="kegiatan"><?= $select['name_issue']; ?></textarea>
                      <br>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Tanggal</label>
                            <input type="date" name="tgl" value="<?= $select['tanggal']; ?>" class="form-control" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <option value="<?= $select['id_user']; ?>"><?= $select['nm_user']; ?></option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <option value="Planing">To Do</option>
                      ...
                      <a href="gambar/<?php echo $select['gambar'] ?>" target="_blank"><img src="gambar/<?php echo $select['gambar']; ?>" width=" 60px" height="60px" class="ml-3 mt-1"></a>
                      <div class="form-group mt-2">
                        <input type="file" class="form-control-file mt-2" name="logo">
                        <small>Masukkan gambar dengan ukuran maksimal 5 MB</small>
                      </div>
                      <br>
                      <input type="hidden" name="id" value="<?= $select['id_issue']; ?>">
                      <input type="hidden" name="gambarLama" value="<?= $select['gambar']; ?>">
                    </div>
